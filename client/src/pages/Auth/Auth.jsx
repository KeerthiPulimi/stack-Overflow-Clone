        ...
        <section className="auth-section">
            ...
            <div className="auth-container-2">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {isSignup && (
                        <label htmlFor="check">
                            <input type="checkbox" name="" id="check" style={{ height: "20px" }} />
                            <p style={{ fontSize: "13px" }}>Opt-in to receive occasional,<br />product updates ,user research invitations,<br />company annonucements, and digests.</p></label>
                    )}
